                ...
                <div class="column is-8">
                    <div class="box">
                        ...
                        <b-table
                            ...
                            <b-table-column field="door_id" label="ID" v-slot="props">
                                {{ props.row.door_id }}
                            </b-table-column>
                            ...
                            <b-table-column label="Action" v-slot="props">
                                <div class="is-flex">
                                    <b-tooltip label="Edit" type="is-warning">
                                        <b-button class="button is-small is-warning mr-1" tag="a" icon-right="pencil" @click="getData(props.row.door_id)"></b-button>
                                    </b-tooltip>
                                    <b-tooltip label="Delete" type="is-danger">
                                        <b-button class="button is-small is-danger mr-1" icon-right="delete" @click="confirmDelete(props.row.door_id)"></b-button>
                                    </b-tooltip>
                                </div>
                            </b-table-column>
            ...
            <form @submit.prevent="submit">
                <div class="modal-card">
                    <header class="modal-card-head">
                        <p class="modal-card-title">New/Update Door Information</p>
                        <button
                            type="button"
                            class="delete"
